...
namespace BoardGames.DataContract.Migrations
{
    ...
    [Migration("20240505054605_add-Identity-table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoardGames.DataContract.Models.BoardGameUser", b =>
                {
            ...
            modelBuilder.Entity("BoardGames.DataContract.Models.BoardGames_Categories", b =>
                {
                    b.Property<int>("BoardGameId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BoardGames.DataContract.Models.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BoardGames.DataContract.Models.Publisher", b =>
                {
                    b.Property<int>("PublisherId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BoardGames.DataContract.Models.BoardGame", b =>
                {
                    b.HasOne("BoardGames.DataContract.Models.Publisher", null)
                        .WithMany("BoardGames")
            ...
            modelBuilder.Entity("BoardGames.DataContract.Models.BoardGames_Categories", b =>
                {
                    ...
                    b.HasOne("BoardGames.DataContract.Models.Category", "Category")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BoardGames.DataContract.Models.BoardGameUser", null)
                        .WithMany()
